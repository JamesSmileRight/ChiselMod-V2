...
import com.chiselranks.command.RankCommand;
...
import com.chiselranks.command.UpdateTagsCommand;
...
public class ChiselRanksPlugin extends JavaPlugin {
    ...
    private void registerCommands() {
        ...
        registerCommand("rank", rankCommand, rankCommand);
        UpdateTagsCommand updateTagsCommand = new UpdateTagsCommand(this, nameTagManager);
        registerCommand("updatetags", updateTagsCommand);
